...
{
    internal class Mine : GameObjectBase
    {
        ...
        internal Mine(Game game, Vector2 startPosition, int labyrinthCorX, int labyrinthCorY)
        ...
        protected override void LoadContent()
        {
            ...
            _spriteTexture = Game.Content.Load<Texture2D>("Mine");
